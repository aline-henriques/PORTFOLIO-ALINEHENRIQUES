...
const PROJECTS = [
  ...
  {
    title: "Lumière Salon",
    desc: "Landing page de salão de beleza premium.",
    url: "https://github.com/aline-henriques/LUMIERE-SALON",
    stack: ["Next.js", "Tailwind", "Frontend"],
  },
  {
    title: "Portfólio Cliente",
    desc: "Portfólio pessoal com design sofisticado.",
    url: "#",
    stack: ["Next.js", "UI/UX", "Frontend"],
  },
];
